...
=head1 NAME
  ...
  create_multiple_database_x7_from_12.2.1.1.pl - use to create the sepecified version db on odalite

=head1 SYNOPSIS

  create_multiple_database_x7_from_12.2.1.1.pl -v <db_version,eg.170814> -n_11 <number of 11g db to be created> -n_121 <number of 12c db to be created> -n_122 <> -home_11 <number of 11g home> -home_121 <number of 12c home> -home_122 <>
  ...
  EXAMPLES:
   perl create_multiple_database_x7_from_12.2.1.1.pl -v 170814 -n_11 3 -n_121 3 -n_122 3 -home_11 2 -home_121 3 -home_122 3
...
if(defined $num1 && $num1>=1){
	for my $i(1..$num1){
		...
		print "create 11204 $dbname successfully!Time is:".(time()-$t)."\n" if(create_database($dbname, $db_password, "-cl $dbtype11 $home_version $choose_co -r acfs"));
		}
 }
 if(defined $num2 && $num2>=1){
	...
	for my $i(1..$num1){
		...
		$dbname=name_generate(@dataSource, '8');
		print "create 11204 $dbname successfully!Time is:".(time()-$t)."\n" if(create_database($dbname, $db_password, "-cl OLTP $home_version $choose_co -r acfs"));
		}
	} 
	if(defined $num2 && $num2>=1){
		for my $i(1..$num2){
