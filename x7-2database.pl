...
my @version=('12.1.0.2.170814','12.2.0.1.170814','11.2.0.4.170814');
my $version;
...
my @shape;
@shape=@shape_source[0..($cpucore_num/2+1)] if($cpucore_num le 12);
@shape=@shape_source[0..7] if($cpucore_num eq 14 );
@shape=@shape_source[0..8] if($cpucore_num eq 18 ||$cpucore_num eq 16);
@shape=@shape_source[0..9] if($cpucore_num eq 20 ||$cpucore_num eq 22);
@shape=@shape_source[0..10] if($cpucore_num ge 24 && $cpucore_num lt 32);
@shape=@shape_source[0..11] if($cpucore_num ge 32 && $cpucore_num lt 36);
@shape=@shape_source if($cpucore_num eq 36);
my @shape_se;
@shape_se12=@shape_source_se12[0..($cpucore_num/2+1)];
my $shape=join ', ', @shape;
